...
function renderWorkbench() {
  ...
  const restricted = records.filter((record) => /partial|restricted|marker|research-room|mixed/i.test(record.releaseStatus || ""));
  ...
  nodes.workbenchRoot.replaceChildren(
    ...
    metricCard("Restriction markers", restricted.length, "Partial, mixed-status, or research-room rows that need source-copy checks."),
